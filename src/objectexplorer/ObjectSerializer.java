...
public class ObjectSerializer {
	...
	public static class Footprint {
		 ...
		 * @param primitives
		 *            the number of primitives (represented by the respective
		 *            primitive classes, e.g. {@code int.class} etc)
		 */
		...
		/**
		 * Returns the number of primitives of this footprint (represented by
		 * the respective primitive classes, {@literal e.g.} {@code int.class}
		 * etc).
		 */
		...
		public String toString() {
			return Objects.toStringHelper(this).add("Objects", objects)
							.add("References", references).add("Primitives", primitives).toString();
		}
	}
